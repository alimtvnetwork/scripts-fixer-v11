...
<img src="../../assets/icon-v1-rocket-stack.svg" alt="Script 43 — Install Llama Cpp" width="128" height="128"/>
...
Implementation folder for **Script 43 — Install Llama Cpp**. The full design contract lives in the spec.
...
- [Full spec](../../spec/43-install-llama-cpp/readme.md)
